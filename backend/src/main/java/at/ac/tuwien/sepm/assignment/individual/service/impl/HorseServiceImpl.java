...
public class HorseServiceImpl implements HorseService {
  ...
  @Override
  public HorseDetailDto getById(long id, int generations) throws NotFoundException {
    LOG.trace("familytree({})", id);
    Horse horse = dao.getById(id);
    var horses = dao.getAll();
    ...
    Map<Long, OwnerDto> ownerMap;
    ownerMap = ownerService.getAllById(ownerIds);
    var familyTree = mapper.entityToDetailDtoLimited(
        horse,
        ownerMap, horses, generations);
    LOG.info("Generated familytree:" + familyTree);
    return familyTree;
  }
